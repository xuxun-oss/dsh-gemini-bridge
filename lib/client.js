...
function GeminiSettingsPage() {
  ...
  return h("div", { className: "gbr" },
    h("div", { className: "gbr-desc" },
      "用常规 DeepSeek 模型即可自动调用视觉/生图能力：gemini_vision（识别）、gemini_generate_image（生图，自动视觉自检）、gemini_optimize_image（改图/优化）。" +
      "支持多种后端（默认 Gemini，也可选 OpenAI 兼容后端接入 Qwen-VL / GLM-4V / GPT-4o / gpt-image 等），无需手动切换模型。API Key 保存在 ~/.dsh/gemini-bridge.json。"
    ),
