...
function GeminiSettingsPage() {
  var apiKey = React.useState("")[0], setApiKey = React.useState("")[1];
  var endpoint = React.useState("https://generativelanguage.googleapis.com/v1beta")[0], setEndpoint = React.useState("https://generativelanguage.googleapis.com/v1beta")[1];
  var visionModel = React.useState("auto")[0], setVisionModel = React.useState("auto")[1];
  var imageModel = React.useState("auto")[0], setImageModel = React.useState("auto")[1];
  var autoRefine = React.useState(true)[0], setAutoRefine = React.useState(true)[1];
  var rounds = React.useState(1)[0], setRounds = React.useState(1)[1];
  var visionList = React.useState([])[0], setVisionList = React.useState([])[1];
  var imageList = React.useState([])[0], setImageList = React.useState([])[1];
  var status = React.useState("加载中…")[0], setStatus = React.useState("加载中…")[1];
  var busy = React.useState(false)[0], setBusy = React.useState(false)[1];
